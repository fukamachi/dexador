...
(defun get (uri &rest args
  ...
  (declare (ignore version headers keep-alive use-connection-pool timeout max-redirects force-binary ssl-key-file ssl-cert-file ssl-key-password socket verbose))
...
(defun post (uri &rest args
             &key version headers content keep-alive use-connection-pool timeout force-binary
               ssl-key-file ssl-cert-file ssl-key-password socket verbose)
  (declare (ignore version headers content keep-alive use-connection-pool timeout force-binary ssl-key-file ssl-cert-file ssl-key-password socket verbose))
...
(defun delete (uri &rest args
               &key version headers keep-alive use-connection-pool timeout force-binary
                 ssl-key-file ssl-cert-file ssl-key-password socket verbose)
  (declare (ignore version headers keep-alive use-connection-pool timeout force-binary ssl-key-file ssl-cert-file ssl-key-password socket verbose))
